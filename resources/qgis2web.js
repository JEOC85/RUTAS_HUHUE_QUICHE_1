...
map.getView().fit([-10288801.598667, 1705283.076739, -10038021.729979, 1822660.874703], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">RUTAS SELECCIONADAS HUHUETENANGO QUICHE</h2>';
        return titleElement;
    })(),
